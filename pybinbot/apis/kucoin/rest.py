...
def _check_rate_limit(remaining: str | int, endpoint: str) -> None:
...
class KucoinRest:
    ...
    def setup_futures_api(self) -> None:
        ...
        self.futures_account_api = (
            self.futures_client.rest_service().get_account_service().get_account_api()
        )
        self.transfer_api = (
            self.futures_client.rest_service().get_account_service().get_transfer_api()
        )
