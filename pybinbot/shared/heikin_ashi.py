...
class HeikinAshi:
    ...
    def is_15m_parity_check_due(cls, parity_symbol: str | None) -> bool:
        symbol_key = parity_symbol or "UNKNOWN"
    ...
    def _run_15m_parity_check(
        ...
        symbol_key = parity_symbol or "UNKNOWN"
        if not self.is_15m_parity_check_due(symbol_key):
            return
    ...
    def pre_process(
        ...
        # 15m synthetic candles from 5m input for parity/backtest checks.
        ...
        df_15m["timestamp"] = to_datetime(df_15m["close_time"], unit="ms")
        ...
        plain_df = cast(DataFrame, df_15m.reset_index(drop=True))
